...
\author{Sun Yudong}
\newcommand{\datum}[0]{December 28, 2019}
\date{{\normalsize caa.} \datum}
...
\section{Translation of Licence}
    ...
    Unfortunately, the translation provided by the Automobile Association in Singapore through the International Driving Permit (IDP) is \textbf{not accepted} as a valid translation of the licence. You will need the following document instead:
